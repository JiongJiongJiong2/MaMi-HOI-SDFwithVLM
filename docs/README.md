...
- [E3 local data gate protocol](experiments/e3-data-gate-protocol-2026-09-20.md)：B 接触记忆与 C 交接研究的本地数据门。
...
- [EPIC-Contact strict lifecycle dataset](experiments/epic-contact-strict-lifecycle-2026-09-20.md)：1 mm、participant/video-disjoint train/dev/test gate 通过。
